...
20. Compilation or runtime failure in Flutter profile mode
    1. Please add the `buildModeSet` field in the OHOS project `build_profile.json5`. You can refer to [complex_layout](https://atomgit.com/openharmony-tpc/flutter_flutter/blob/3.22.0-ohos/dev/benchmarks/complex_layout/ohos/build-profile.json5).
    2. Error message:
      ```
