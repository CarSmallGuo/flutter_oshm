...
2. This repository is built based on the Flutter official community version 3.32.4
   * [sdk base version](https://github.com/flutter/flutter/tree/3.32.4)
...
## Upgrade Guide
1. If your project is upgrading from HarmonyOS version 3.27.4 to version 3.32.4:
   * Environment dependencies: Configuration remains consistent between the two versions, no additional modifications required.
   * For new features and changes from 3.27.4 to 3.32.4, please refer to the [Release Notes](https://docs.flutter.dev/release/release-notes).
   ...
   * Third-party libraries:
      - Pure Dart libraries should be upgraded to the specified version to support 3.32.4.
2. If your project is migrating from Android or iOS to the HarmonyOS adaptation for version 3.32.4, please refer to the remaining guide documents.
...
* Environment configuration
   ...
   2. Download the current warehouse code `git clone https://gitcode.com/openharmony-tpc/flutter_flutter.git` Specify the oh-3.32.4-dev branch and configure the environment
