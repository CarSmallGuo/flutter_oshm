...
void _appendCommands(List<String> command, OhosBuildInfo ohosBuildInfo,
  ...
  if (globals.artifacts is LocalEngineArtifacts) {
    ...
    command.addAll(<String>[
      '-p',
      'FLUTTER_ENGINE=${globals.fs.path.dirname(globals.fs.path.dirname(localEngineArtifacts.engineOutPath))}'
    ]);
    command.addAll(<String>[
      '-p',
      'LOCAL_ENGINE=${localEngineArtifacts.localEngineName}',
    ]);
    command.addAll(<String>[
      '-p',
      'TARGET_PLATFORM=${_getTargetPlatformByLocalEnginePath(localEngineArtifacts.engineOutPath)}',
    ]);
