...
20. flutter profile模式下编译或运行失败
    1. 请在ohos项目build_profile.json5中添加buildModeSet字段，可参考[complex_layout](https://atomgit.com/openharmony-tpc/flutter_flutter/blob/3.22.0-ohos/dev/benchmarks/complex_layout/ohos/build-profile.json5)
    2. 报错信息:
      ```
